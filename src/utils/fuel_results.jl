...
function make_fuel_dictionary(system::PSY.System, res::PSI.SimulationResults; kwargs...)
...
function make_fuel_dictionary(system::PSY.System, res::PSI.DualResults; kwargs...)
    results = OperationsProblemResults(res.variables, res.total_cost, 
    res.optimizer_log, res.time_stamp)
    make_fuel_dictionary(system, results; kwargs...)
end
